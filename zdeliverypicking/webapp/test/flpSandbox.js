		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comamizdeliverypicking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizdeliverypicking-display": {
								"semanticObject": "comamizdeliverypicking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zdeliverypicking",
									"url": sap.ui.require.toUrl("com/ami/zdeliverypicking")
								}
							}
						}
					}
