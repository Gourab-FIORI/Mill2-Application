		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comamiztruckmonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamiztruckmonitor-display": {
								"semanticObject": "comamiztruckmonitor",
								"action": "display",
								"description": "Truck Monitoring An SAP Fiori application.",
								"title": "Truck Monitoring ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.ztruckmonitor",
									"url": sap.ui.require.toUrl("com/ami/ztruckmonitor")
								}
							}
						}
					}
