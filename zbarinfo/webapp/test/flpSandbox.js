		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comamizbarinformationzbarinfo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizbarinformationzbarinfo-display": {
								"semanticObject": "comamizbarinformationzbarinfo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zbarinformation.zbarinfo",
									"url": sap.ui.require.toUrl("com/ami/zbarinformation/zbarinfo")
								}
							}
						}
					}
