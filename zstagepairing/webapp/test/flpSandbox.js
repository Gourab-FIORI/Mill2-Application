		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comamizstagepairing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizstagepairing-display": {
								"semanticObject": "comamizstagepairing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zstagepairing",
									"url": sap.ui.require.toUrl("com/ami/zstagepairing")
								}
							}
						}
					}
