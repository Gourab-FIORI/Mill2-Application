		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comamizupdatedefect-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizupdatedefect-display": {
								"semanticObject": "comamizupdatedefect",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zupdatedefect",
									"url": sap.ui.require.toUrl("com/ami/zupdatedefect")
								}
							}
						}
					}
