		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commovetosingleunitmovetosingleunit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commovetosingleunitmovetosingleunit-display": {
								"semanticObject": "commovetosingleunitmovetosingleunit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.movetosingleunit.movetosingleunit",
									"url": sap.ui.require.toUrl("com/movetosingleunit/movetosingleunit")
								}
							}
						}
					}
