		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ordinazmmphysicalinv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordinazmmphysicalinv-display": {
								"semanticObject": "ordinazmmphysicalinv",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordina.zmmphysicalinvn",
									"url": sap.ui.require.toUrl("ordina/zmmphysicalinvn")
								}
							}
						}
					}
