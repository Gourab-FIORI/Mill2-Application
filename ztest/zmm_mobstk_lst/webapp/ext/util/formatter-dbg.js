jQuery.sap.declare("ZMM.zmm_mobstock_lst.ext.util.formatter");
jQuery.sap.require("sap.ui.core.format.NumberFormat");
jQuery.sap.require("sap.ui.core.format.DateFormat");

ZMM.zmm_mobstock_lst.ext.util.formatter = {
	...
	****************************************************************************/
	...
	formatBtnTransferVisible: function(sStorageLocation,sInventoryStockType) {
		if(!sStorageLocation || sStorageLocation === "") {
			return false;
		}
		return sInventoryStockType && sInventoryStockType !== "02";
	}
};