		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comamizbintransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizbintransfer-display": {
								"semanticObject": "comamizbintransfer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zbintransfer",
									"url": sap.ui.require.toUrl("com/ami/zbintransfer")
								}
							}
						}
					}
