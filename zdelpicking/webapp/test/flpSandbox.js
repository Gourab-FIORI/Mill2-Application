		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comamizdelpicking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizdelpicking-display": {
								"semanticObject": "comamizdelpicking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zdelpicking",
									"url": sap.ui.require.toUrl("com/ami/zdelpicking")
								}
							}
						}
					}
