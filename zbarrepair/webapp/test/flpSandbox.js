		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bar Repair",
									"targetURL": "#comamizbarrepair-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizbarrepair-display": {
								"semanticObject": "comamizbarrepair",
								"action": "display",
								"description": "Bar Repair Fiori application.",
								"title": "Bar Repair",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zbarrepair",
									"url": sap.ui.require.toUrl("com/ami/zbarrepair")
								}
							}
						}
					}
