		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Print Label",
									"targetURL": "#comamizprintlabel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizprintlabel-display": {
								"semanticObject": "comamizprintlabel",
								"action": "display",
								"description": "An SAP Fiori application for Printing Labels",
								"title": "Print Label",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zprintlabel",
									"url": sap.ui.require.toUrl("com/ami/zprintlabel")
								}
							}
						}
					}
