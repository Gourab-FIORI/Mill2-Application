		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bar Cutting",
									"targetURL": "#comamizbarcutting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizbarcutting-display": {
								"semanticObject": "comamizbarcutting",
								"action": "display",
								"description": "BAR Cutting SAP Fiori application.",
								"title": "Bar Cutting",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zbarcutting",
									"url": sap.ui.require.toUrl("com/ami/zbarcutting")
								}
							}
						}
					}
