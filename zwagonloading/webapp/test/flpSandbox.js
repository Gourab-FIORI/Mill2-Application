		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Wagon Loading",
									"targetURL": "#comamizwagonloading-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizwagonloading-display": {
								"semanticObject": "comamizwagonloading",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zwagonloading",
									"url": sap.ui.require.toUrl("com/ami/zwagonloading")
								}
							}
						}
					}
