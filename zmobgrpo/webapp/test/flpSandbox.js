		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Good receipt against Purchase Order Light",
									"targetURL": "#comamizmobgrpo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizmobgrpo-display": {
								"semanticObject": "comamizmobgrpo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zmobgrpo",
									"url": sap.ui.require.toUrl("com/ami/zmobgrpo")
								}
							}
						}
					}
