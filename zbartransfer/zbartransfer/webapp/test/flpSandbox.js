		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bar Transfer",
									"targetURL": "#comamizbartransfer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comamizbartransfer-display": {
								"semanticObject": "comamizbartransfer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ami.zbartransfer",
									"url": sap.ui.require.toUrl("com/ami/zbartransfer")
								}
							}
						}
					}
